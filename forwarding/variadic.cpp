...
// also read:
// https://stackoverflow.com/questions/45041538/variadic-templates-with-forward-reference-and-operator
...
Case
f( int& x, char& c, double& d )
{
    return Case::Variable;
}

Case
f( const int& x, const char& c, const double& d )
{
...
TEST_CASE( "forward variadic arguments" )
{
    int i = 1;
    char c = '1';
    double d = 1.0;
