...
// this section explains function template type-deduction rules, and which type of
// parameter can not be deduced from the call arguments; this remind me the concept of
// phantom type in haskell (read: the proof of the departed ghost), a non-participating
// type parameter that influences a dispatching logic further down
